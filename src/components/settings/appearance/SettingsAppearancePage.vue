...
<template>
  ...
  <SettingsGroupPanel :title="t('settings_labels.appearance.group_interface')">
    <settings-switch
  ...
  <SettingsGroupPanel :title="t('settings_labels.appearance.group_editing')">
    <settings-switch
  ...
  <SettingsGroupPanel
    :title="t('settings_labels.appearance.group_layout')"
    :spaced="false"
  >
