...
export const API_ROUTES = {
  ...
  tagDuplicate: '/api/Tag/duplicate',
  meta: '/api/Meta',
  metaMergeCategories: '/api/Meta/mergeCategories',
  metaDuplicate: '/api/Meta/duplicate',
  ...
  tagsInTagCreateOne: '/api/TagsInTag/createOne',
  ...
  mediaTrashList: '/api/Media/trash',
  mediaTrashRestore: '/api/Media/trash/restore',
  mediaTrashPurge: '/api/Media/trash/purge',
  mediaTrashPurgeExpired: '/api/Media/trash/purgeExpired',
  tagTrashList: '/api/Tag/trash',
  tagTrashRestore: '/api/Tag/trash/restore',
  tagTrashPurge: '/api/Tag/trash/purge',
  tagTrashPurgeExpired: '/api/Tag/trash/purgeExpired',
  markTrashList: '/api/Mark/trash',
  markTrashRestore: '/api/Mark/trash/restore',
  markTrashPurge: '/api/Mark/trash/purge',
  markTrashPurgeExpired: '/api/Mark/trash/purgeExpired',
  playlistTrashList: '/api/Playlist/trash',
  playlistTrashRestore: '/api/Playlist/trash/restore',
  playlistTrashPurge: '/api/Playlist/trash/purge',
  playlistTrashPurgeExpired: '/api/Playlist/trash/purgeExpired',
  savedFilterTrashList: '/api/SavedFilter/trash',
  savedFilterTrashRestore: '/api/SavedFilter/trash/restore',
  savedFilterTrashPurge: '/api/SavedFilter/trash/purge',
  savedFilterTrashPurgeExpired: '/api/SavedFilter/trash/purgeExpired',
  ...
  taskTrimVideo: '/api/Task/trimVideo',
  taskTrimVideoDeleteOriginal: '/api/Task/trimDeleteOriginal',
  taskTrim: '/api/Task/trim',
  taskConversion: '/api/Task/conversion',
  ...
  taskEnsureMediaMetadataBulk: '/api/Task/ensureMediaMetadataBulk',
  ...
  libraryResetMedia: '/api/LibraryReset/media',
  libraryResetTags: '/api/LibraryReset/tags',
  libraryResetCounts: '/api/LibraryReset/counts',
  ...
  browseDeleteEntries: '/api/browse/deleteEntries',
  browseCopyEntries: '/api/browse/copyEntries',
  browseMoveEntries: '/api/browse/moveEntries',
  browseCreateFolder: '/api/browse/createFolder',
  browseRenameEntry: '/api/browse/renameEntry',
  ...
  taskMediaCreatedBackfillStatus: '/api/Task/mediaCreatedBackfillStatus',
  taskStreamMediaCreatedBackfill: '/api/Task/streamMediaCreatedBackfill',
